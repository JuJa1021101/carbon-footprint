...
function initRuntimeSocketService() {
  const hosts = "192.168.109.1,192.168.16.1,172.28.231.238,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_2-QK7N";
...
const pages = [
  ...
  {
    path: "pages/admin/activity-list",
    style: {
      navigationBarTitleText: "环保活动管理",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/activity-add",
    style: {
      navigationBarTitleText: "添加环保活动",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/activity-edit",
    style: {
      navigationBarTitleText: "编辑环保活动",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/reward-list",
    style: {
      navigationBarTitleText: "积分商城奖品管理",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/reward-add",
    style: {
  ...
  {
    path: "pages/admin/knowledge-list",
    style: {
      navigationBarTitleText: "环保知识管理",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/knowledge-add",
    style: {
      navigationBarTitleText: "添加环保知识",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/admin/knowledge-edit",
    style: {
      navigationBarTitleText: "编辑环保知识",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/home/knowledge-list",
    style: {
      navigationBarTitleText: "环保知识与小贴士",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/home/knowledge-detail",
    style: {
  ...
  {
    path: "pages/home/activity-detail",
    style: {
  ...
  {
    path: "pages/community/post-publish",
    style: {
  ...
  {
    path: "pages/profile/address-edit",
    style: {
  ...
  {
    path: "pages/admin/reset-points",
    style: {
      navigationBarTitleText: "积分系统重置",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/home/knowledge-static",
    style: {
      navigationBarTitleText: "环保知识详情",
      navigationStyle: "custom"
    }
  }
];
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "社区",
      iconPath: "static/images/tab/tab-community.png",
      selectedIconPath: "static/images/tab/tab-community-active.png"
    },
    {
      pagePath: "pages/checkin/checkin",
      text: "打卡",
      iconPath: "static/images/tab/tab-checkin.png",
      selectedIconPath: "static/images/tab/tab-checkin-active.png"
    },
    {
      pagePath: "pages/mall/mall",
      text: "积分商城",
      iconPath: "static/images/tab/tab-mall.png",
      selectedIconPath: "static/images/tab/tab-mall-active.png"
    },
    {
      pagePath: "pages/profile/profile",
      text: "我的",
      iconPath: "static/images/tab/tab-profile.png",
      selectedIconPath: "static/images/tab/tab-profile-active.png"
    }
  ]
};
const easycom = {
...
var define_process_env_UNI_SECURE_NETWORK_CONFIG_default = [{ provider: "aliyun", spaceId: "mp-6cf8d087-e3fc-400d-a785-98dd814a07f4", config: { accessControl: { enable: false, function: {} } } }, { provider: "aliyun", spaceId: "mp-6cf8d087-e3fc-400d-a785-98dd814a07f4", config: { accessControl: { enable: false, function: {} } } }];
function t(e2) {
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.109.1","192.168.16.1","172.28.231.238"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Software/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"carbon-footprint","spaceId":"mp-6cf8d087-e3fc-400d-a785-98dd814a07f4","clientSecret":"UpBcDMvg3U573zzF8Ef7zg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__3287740";
} catch (e2) {
...
const Qt = "none", Xt = "request", Zt = "response", en = "both";
class tn {
  constructor({ secretType: e2, uniCloudIns: t2 } = {}) {
    this.clientType = "", this.secretType = e2 || Qt, this.uniCloudIns = t2;
  ...
  async encryptData(e2) {
    return this.secretType === Qt ? e2 : this.platformEncryptData(e2);
  }
  async decryptResult(e2) {
    if (this.secretType === Qt)
      return e2;
    const { errCode: t2, content: n2 } = e2 || {};
    return t2 || !n2 ? e2 : this.secretType === Xt ? n2 : this.platformDecryptResult(e2);
  }
...
var cn, un = { toBytes: function(e2) {
  ...
  return t2.join("");
} }, hn = (cn = "0123456789abcdef", { toBytes: function(e2) {
...
class Cn {
  constructor(e2) {
    ...
    Object.defineProperty(this, "key", { value: rn(e2, true) }), this._prepare();
  }
  _prepare() {
    var e2 = ln[this.key.length];
    if (null == e2)
      throw new Error("invalid key size (must be 16, 24 or 32 bytes)");
    this._Ke = [], this._Kd = [];
    for (var t2 = 0; t2 <= e2; t2++)
      this._Ke.push([0, 0, 0, 0]), this._Kd.push([0, 0, 0, 0]);
    var n2, s2 = 4 * (e2 + 1), r2 = this.key.length / 4, i2 = Pn(this.key);
    for (t2 = 0; t2 < r2; t2++)
      n2 = t2 >> 2, this._Ke[n2][t2 % 4] = i2[t2], this._Kd[e2 - n2][t2 % 4] = i2[t2];
    for (var o2, a2 = 0, c2 = r2; c2 < s2; ) {
      if (o2 = i2[r2 - 1], i2[0] ^= pn[o2 >> 16 & 255] << 24 ^ pn[o2 >> 8 & 255] << 16 ^ pn[255 & o2] << 8 ^ pn[o2 >> 24 & 255] ^ dn[a2] << 24, a2 += 1, 8 != r2)
        for (t2 = 1; t2 < r2; t2++)
          i2[t2] ^= i2[t2 - 1];
      else {
        for (t2 = 1; t2 < r2 / 2; t2++)
          i2[t2] ^= i2[t2 - 1];
        o2 = i2[r2 / 2 - 1], i2[r2 / 2] ^= pn[255 & o2] ^ pn[o2 >> 8 & 255] << 8 ^ pn[o2 >> 16 & 255] << 16 ^ pn[o2 >> 24 & 255] << 24;
    ...
    for (var u2 = 1; u2 < e2; u2++)
      for (var h2 = 0; h2 < 4; h2++)
        o2 = this._Kd[u2][h2], this._Kd[u2][h2] = bn[o2 >> 24 & 255] ^ kn[o2 >> 16 & 255] ^ Tn[o2 >> 8 & 255] ^ An[255 & o2];
  }
  encrypt(e2) {
    if (16 != e2.length)
      throw new Error("invalid plaintext size (must be 16 bytes)");
    for (var t2 = this._Ke.length - 1, n2 = [0, 0, 0, 0], s2 = Pn(e2), r2 = 0; r2 < 4; r2++)
      s2[r2] ^= this._Ke[0][r2];
    for (var i2 = 1; i2 < t2; i2++) {
      for (r2 = 0; r2 < 4; r2++)
        n2[r2] = gn[s2[r2] >> 24 & 255] ^ mn[s2[(r2 + 1) % 4] >> 16 & 255] ^ yn[s2[(r2 + 2) % 4] >> 8 & 255] ^ _n[255 & s2[(r2 + 3) % 4]] ^ this._Ke[i2][r2];
      s2 = n2.slice();
    }
    var o2, a2 = on(16);
    for (r2 = 0; r2 < 4; r2++)
      o2 = this._Ke[t2][r2], a2[4 * r2] = 255 & (pn[s2[r2] >> 24 & 255] ^ o2 >> 24), a2[4 * r2 + 1] = 255 & (pn[s2[(r2 + 1) % 4] >> 16 & 255] ^ o2 >> 16), a2[4 * r2 + 2] = 255 & (pn[s2[(r2 + 2) % 4] >> 8 & 255] ^ o2 >> 8), a2[4 * r2 + 3] = 255 & (pn[255 & s2[(r2 + 3) % 4]] ^ o2);
    return a2;
  }
  decrypt(e2) {
    if (16 != e2.length)
      throw new Error("invalid ciphertext size (must be 16 bytes)");
    for (var t2 = this._Kd.length - 1, n2 = [0, 0, 0, 0], s2 = Pn(e2), r2 = 0; r2 < 4; r2++)
      s2[r2] ^= this._Kd[0][r2];
    for (var i2 = 1; i2 < t2; i2++) {
      for (r2 = 0; r2 < 4; r2++)
        n2[r2] = wn[s2[r2] >> 24 & 255] ^ vn[s2[(r2 + 3) % 4] >> 16 & 255] ^ In[s2[(r2 + 2) % 4] >> 8 & 255] ^ Sn[255 & s2[(r2 + 1) % 4]] ^ this._Kd[i2][r2];
      s2 = n2.slice();
    }
    var o2, a2 = on(16);
    for (r2 = 0; r2 < 4; r2++)
      o2 = this._Kd[t2][r2], a2[4 * r2] = 255 & (fn[s2[r2] >> 24 & 255] ^ o2 >> 24), a2[4 * r2 + 1] = 255 & (fn[s2[(r2 + 3) % 4] >> 16 & 255] ^ o2 >> 16), a2[4 * r2 + 2] = 255 & (fn[s2[(r2 + 2) % 4] >> 8 & 255] ^ o2 >> 8), a2[4 * r2 + 3] = 255 & (fn[255 & s2[(r2 + 1) % 4]] ^ o2);
    return a2;
  }
}
class xn {
  ...
  encrypt(e2) {
    if ((e2 = rn(e2)).length % 16 != 0)
      throw new Error("invalid plaintext size (must be multiple of 16 bytes)");
    for (var t2 = on(e2.length), n2 = on(16), s2 = 0; s2 < e2.length; s2 += 16)
...
class On {
  constructor(e2, t2) {
    ...
    if (this.description = "Cipher Block Chaining", this.name = "cbc", t2) {
      ...
      t2 = on(16);
    this._lastCipherblock = rn(t2, true), this._aes = new Cn(e2);
  }
  encrypt(e2) {
    if ((e2 = rn(e2)).length % 16 != 0)
      throw new Error("invalid plaintext size (must be multiple of 16 bytes)");
...
class En {
  constructor(e2, t2, n2) {
    ...
    if (this.description = "Cipher Feedback", this.name = "cfb", t2) {
      ...
      t2 = on(16);
    n2 || (n2 = 1), this.segmentSize = n2, this._shiftRegister = rn(t2, true), this._aes = new Cn(e2);
  }
  encrypt(e2) {
    if (e2.length % this.segmentSize != 0)
      throw new Error("invalid plaintext size (must be segmentSize bytes)");
    for (var t2, n2 = rn(e2, true), s2 = 0; s2 < n2.length; s2 += this.segmentSize) {
...
class Ln {
  constructor(e2, t2) {
    ...
    if (this.description = "Output Feedback", this.name = "ofb", t2) {
      ...
      t2 = on(16);
    this._lastPrecipher = rn(t2, true), this._lastPrecipherIndex = 16, this._aes = new Cn(e2);
  }
  encrypt(e2) {
    for (var t2 = rn(e2, true), n2 = 0; n2 < t2.length; n2++)
...
class Rn {
  constructor(e2) {
    ...
    0 === e2 || e2 || (e2 = 1), "number" == typeof e2 ? (this._counter = on(16), this.setValue(e2)) : this.setBytes(e2);
  }
  setValue(e2) {
...
class Un {
  constructor(e2, t2) {
    if (!(this instanceof Un))
      throw Error("AES must be instanitated with `new`");
    this.description = "Counter", this.name = "ctr", t2 instanceof Rn || (t2 = new Rn(t2)), this._counter = t2, this._remainingCounter = null, this._remainingCounterIndex = 16, this._aes = new Cn(e2);
  }
  encrypt(e2) {
    for (var t2 = rn(e2, true), n2 = 0; n2 < t2.length; n2++)
...
var Nn = { AES: Cn, Counter: Rn, ModeOfOperation: { ecb: xn, cbc: On, cfb: En, ofb: Ln, ctr: Un }, utils: { hex: hn, utf8: un }, padding: { pkcs7: { pad: function(e2) {
  var t2 = 16 - (e2 = rn(e2, true)).length % 16, n2 = on(e2.length + t2);
  an(e2, n2);
  for (var s2 = e2.length; s2 < n2.length; s2++)
    n2[s2] = t2;
  return n2;
}, strip: function(e2) {
  if ((e2 = rn(e2, true)).length < 16)
...
} } }, _arrayTest: { coerceArray: rn, createArray: on, copyArray: an } };
function Dn(e2, t2, n2) {
  const s2 = new Uint8Array(index.base64ToArrayBuffer(t2)), r2 = Nn.utils.utf8.toBytes(n2), i2 = Nn.utils.utf8.toBytes(e2), o2 = new Nn.ModeOfOperation.cbc(s2, r2), a2 = Nn.padding.pkcs7.pad(i2), c2 = o2.encrypt(a2);
  return index.arrayBufferToBase64(c2);
}
const Mn = { code: 2e4, message: "System error" }, qn = { code: 20101, message: "Invalid client" }, Kn = { code: 20102, message: "Get encrypt key failed" };
function jn(e2) {
...
class Hn extends tn {
  ...
  async getUserEncryptKey() {
    ...
    if (Wn && Wn.expireTime) {
      const e2 = Date.now();
      if (Wn.expireTime - e2 > 0)
        return this.userEncryptKey = Wn, this.userEncryptKey;
    }
    return new Promise((e2, t2) => {
      index.getUserCryptoManager().getLatestUserKey({ success: (t3) => {
        Wn = t3, this.userEncryptKey = t3, e2(this.userEncryptKey);
      }, fail: (e3) => {
        t2(jn({ ...Kn, cause: e3 }));
      } });
    });
  ...
  async platformGetSignOption() {
    ...
    return { verifyClientSign: Dn(JSON.stringify({ data: JSON.stringify({}), appId: this.appId, deviceId: this.deviceId, wxAppId: this.getWxAppId(), simulator: "devtools" === he().platform, timestamp: Date.now() }), e2, t2), encryptKeyId: n2, mpWeixinCode: this.scopedGlobalCache.mpWeixinCode, mpWeixinOpenid: this.scopedGlobalCache.mpWeixinOpenid };
  }
  async platformEncryptData(e2) {
    ...
    return this.secretType === Zt ? { content: e2, _uniCloudOptions: r2 } : { content: Dn(JSON.stringify({ data: JSON.stringify(e2), appId: this.appId, deviceId: this.deviceId, wxAppId: this.getWxAppId(), simulator: "devtools" === he().platform, timestamp: Date.now() }), t2, n2), _uniCloudOptions: r2 };
  }
  async platformDecryptResult(e2) {
    ...
    return JSON.parse(function(e3, t3, n3) {
      const s3 = new Uint8Array(index.base64ToArrayBuffer(e3)), r2 = new Uint8Array(index.base64ToArrayBuffer(t3)), i2 = Nn.utils.utf8.toBytes(n3), o2 = new Nn.ModeOfOperation.cbc(r2, i2), a2 = Nn.padding.pkcs7.strip(o2.decrypt(s3));
      return Nn.utils.utf8.fromBytes(a2);
    }(t2, n2, s2));
  }
  isClientKeyNotFound() {
    return false;
