...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const knowledgeLikeKey = common_vendor.ref("");
    const toggleLike = () => {
      ...
      const likedKeys = common_vendor.index.getStorageSync("likedStaticKnowledge") || [];
      if (isLiked.value) {
      ...
      common_vendor.index.setStorageSync("likedStaticKnowledge", likedKeys);
    ...
    common_vendor.onLoad((options) => {
      common_vendor.index.__f__("log", "at pages/home/knowledge-static.vue:177", "静态知识详情页面参数:", options);
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: knowledge.value.content,
        e: knowledge.value.image,
        f: common_vendor.t(knowledge.value.tag),
        g: common_vendor.t(knowledge.value.time),
        h: common_vendor.o(goBack),
        i: common_vendor.t(knowledge.value.views),
        j: common_vendor.n(isLiked.value ? "icon-like-fill" : "icon-like"),
        k: common_vendor.t(knowledge.value.likes),
        l: isLiked.value ? 1 : "",
        m: common_vendor.o(toggleLike)
      };
    };
  }
};
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/home/knowledge-static.js.map
